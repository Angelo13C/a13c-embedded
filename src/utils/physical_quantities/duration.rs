//! Module for handling duration measurements and conversions.
//!
//! This module provides a versatile [`SmallDuration`] struct for representing duration values in various orders of magnitudes,
//! along with methods for conversion between different orders of magnitudes.
//!
//! # Examples
//!
//! ```
//! # use a13c_embedded::utils::physical_quantities::duration::*;
//! #
//! let second = SmallDuration::from_seconds(1);
//! assert_eq!(second.as_micros(), 1_000_000);
//!
//! let millisecond = SmallDuration::from_millis(1);
//! assert_eq!(millisecond.as_micros(), 1_000);
//!
//! let microsecond = SmallDuration::from_micros(1);
//! assert_eq!(microsecond.as_micros(), 1);
//! ```
...
impl SmallDuration
{
	...
	/// # Examples
	/// ```
	/// # use a13c_embedded::utils::physical_quantities::duration::SmallDuration;
	/// #
...
impl Debug for SmallDuration
{
	...
	{
		write!(f, "Duration: {}ns", self.as_nanos())
	}
}
